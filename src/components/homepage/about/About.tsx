...
const phrasesEn = [
  ...
  ' I build interfaces...',
  ' ...and turn designs into code'
]

const phrasesRu = [
  ' Я фронтенд-разработчик',
  ' Я строю интерфейсы...',
  ' ...и превращаю дизайн в код'
]

const About = ({ lng }: AboutProps) => {
  const phrases = lng === 'ru' ? phrasesRu : phrasesEn
        ...
        <div className="mt-25 flex flex-col items-center">
          ...
          <div className="mt-5 text-[25px] sm:text-[30px] max-w-[700px]">
            <p className="text-center">
              {lng === 'ru'
                ? `Фронтендер, который совмещает логику с эстетикой. 
                   Я проектирую и создаю цифровые продукты, 
                   которые балансируют между удобством для пользователя и целями бизнеса.`
